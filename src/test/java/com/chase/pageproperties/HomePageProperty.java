...
public interface HomePageProperty {
    ...
    public String ChaseSymbol = "//img[@class='logo_1syy1m0']";
    public String RightSideTitle = "//img[@class='tempLogo_1ap3qm0']";
    ...
    public String MoneySaveTitle = "//a[contains(text(),'Auto loans')]";
    public String NewCarSearchTitle = "//p[contains(text(),'Price a New Car')]";
//    public String NewCarSelectMakeDropdown = "//div[@class='padding-right-md-4 padding-bottom-md-0 padding-bottom-4 col-12 col-md-6']//div[@class='text-left']//div[@class='margin-top-4 dropdown']//label[@class='field-container field-size-md field-layout-float field-theme-dark field-emphasized margin-top-4']//div//select[@class='form-control-select-sm']";
//    public String NewCarSelectMakeDropdown = "//div[@data-qa='SelectNewMake']//select[@class='form-control-select-sm']";
